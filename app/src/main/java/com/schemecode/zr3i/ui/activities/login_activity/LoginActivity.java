...
public class LoginActivity extends AppCompatActivity implements LoginContract.view{
    ...
    public void handleCLicks() {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loginPresenter.login(etEmail.getText().toString().trim() , etPass.getText().toString().trim() , "ar" , "android" , "hash_key");
            }
        });
    ...
    private void facebookLogin() {
        ...
        LoginManager.getInstance().logInWithReadPermissions((Activity) LoginActivity.this, Arrays.asList("email", "public_profile"));
